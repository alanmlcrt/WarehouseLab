...
export const scenarios: ScenarioDefinition[] = [
  ...
  scenario(
    "astar-anti-congestion",
    "A* anti-congestion",
    "A* avec cout pondere trafic pour eviter les couloirs satures.",
    {
  ...
  scenario(
    "battery-stress",
    "Battery Stress",
    "Batterie reduite, robots forces de se recharger.",
    {
      robots: {
        maxBattery: 40,
        energyPerCell: 0.6,
  ...
  scenario(
    ...
    "Pic de demande, recharge, congestion et stations en tension.",
    {
      warehouse: {
        width: 24,
        height: 18,
  ...
  scenario(
    ...
    "Rails Guided Placeholder",
    "Scenario rails guides prepare dans l'architecture.",
    {
...
export function cloneConfig(config: SimulationConfig): SimulationConfig {
  const cloned = JSON.parse(JSON.stringify(config)) as SimulationConfig;
...
type ConfigOverrides = {
  warehouse?: Partial<SimulationConfig["warehouse"]>;
  robots?: Partial<SimulationConfig["robots"]>;
  demand?: Partial<SimulationConfig["demand"]>;
  storage?: Partial<SimulationConfig["storage"]> & { strategy?: StorageStrategy };
  movement?: Partial<SimulationConfig["movement"]>;
  seeds?: Partial<SimulationConfig["seeds"]>;
};
